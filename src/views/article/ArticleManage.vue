...
const uploadSuccess = (img) => {
    ...
    // articleModel.value.coverImg="http://localhost:80/img/0ba37bbd-9271-40f7-9282-40c90d5a0c88.png"
...
articleModel.value.title =row.categoryName
    ...
    <el-card class="page-container">
        <template #header>
            <div class="header">
                <span>文章管理</span>
                <div class="extra">
                    <el-button type="primary" @click="title='添加文章';visibleDrawer = true;clearModel()">添加文章</el-button>
                </div>
            </div>
        </template>
        <!-- 搜索表单 -->
